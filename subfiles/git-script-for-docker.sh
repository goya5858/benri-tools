...
export AWS_ACCESS_KEY_ID=$(cat ~/.ssh/env.json | jq ".secrets.AWS_ACCESS_KEY_ID")
export AWS_SECRET_ACCESS_KEY_ID=$(cat ~/.ssh/env.json | jq ".secrets.AWS_SECRET_ACCESS_KEY_ID")
